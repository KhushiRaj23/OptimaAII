...
const DashboardView = ({insights}) => {
    ...
    const lastUpdateDate=insights.lastUpdated ? format(new Date(insights.lastUpdated), "dd/MM/yyyy"):"N/A";

    console.log("Insights Data:", insights);
    console.log("Last Update Date:", insights.lastUpdated);
    console.log("Next Update Date:", insights.nextUpdate);
...
<Card>
  ...
  <CardHeader>
    ...
    <CardDescription>
        Displaying minimun, median, and maximum salaries (in thousands)
    </CardDescription>
  </CardHeader>
  <CardContent>
