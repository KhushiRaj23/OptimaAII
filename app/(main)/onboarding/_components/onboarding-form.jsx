   ...
   const {register, handleSubmit,formState:{errors},setValue,watch}= useForm({
    ...
    const onSubmit=async (values)=>{
        try{
          ...
          const formattedIndustry = `${values.industry.toLowerCase().replace(/ /g, "-")}-${values.subIndustry.toLowerCase().replace(/ /g, "-")}`;

          const payload = {
            ...values,
            industry: formattedIndustry,
          };
          console.log("PayLoad sent to updateUserFn",payload);
...
<div className="space-y-2">
    ...
    placeholder="e.g., Python, JavaScript, Project Managenet"
    {...register("skills")}
    />
...
<div className="space-y-2">
    ...
    placeholder="Tell us about your professional backgrond..."
    className="h-32"
    {...register("bio")}
    />
