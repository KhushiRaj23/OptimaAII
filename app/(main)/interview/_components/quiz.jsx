...
const Quiz = () => {
    ...
    if(!quizData){
        return(
            ...
            <Card className="mx-2">
  <CardHeader>
    <CardTitle>Ready to test your knowladge?</CardTitle>
  </CardHeader>
  <CardContent>
    <p className='text-muted-foreground'> This quiz contain 10 questions specific to your industry and skills. Take your time and choose the best answer for each question.</p>
  </CardContent>
  <CardFooter>
