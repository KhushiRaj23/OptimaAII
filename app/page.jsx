  ...
  <CardContent className="pt-6">
    ...
    <section className="w-full">
      <div className="mx-auto py-24 gradient rounded-lg">
        ...
        Unlock your career potential with AI-driven insights—join thousands of professionals on the path to success.
        </p>
        ...
        >Start Your Journey Today<ArrowRight className="ml-2 h-4 w-4"/></Button>
        </Link>
        </div>        
      </div>
    </section>
